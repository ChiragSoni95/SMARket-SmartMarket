			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Category-Wise</li>						  	
					</ol>
				</div>
			</div>
   ...
   <div class="panel-body">
		<div class="form">
			...
			<form class="form-validate form-horizontal" id="feedback_form"
				...
				<input type="hidden" name="action" value="category_graph">
...
<img src="uploads/<%=request.getAttribute("month")%>.jpg" alt="" height="500" width="1300">
