  ...
  <section id="container" class="">
          ...
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i>Order Stock</li>
    ...
    <div class="panel-body">
	 ...
	 <form class="form-horizontal " method="post" action="<%=request.getContextPath()%>/Controller">
               <input type="hidden" name="action" value="inventory_calc">
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              <label class="control-label col-sm-4">Rate Of Demand:</label>
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="number" min="1" max="99999999999" name="rate_demand" style="width:250px;" placeholder="Expected sale" class="form-control" required>
                                              </div>
                                          </div>
                                          <div class="form-group">
