...
<!-- container section start -->
  <section id="container" class="">
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>New-Product</li>						  	
					</ol>
				</div>
			</div>
	...
	<div class="panel-body">
	 ...
	 <form class="form-horizontal " method="post" action="<%=request.getContextPath()%>/Controller">
               <input type="hidden" name="action" value="classify1">

                              <div class="form-group">
                                              <label class="control-label col-sm-4">Product Id:</label>
                                             <div class="col-sm-6">
                                                  <input id="cp1" type="text" name="product_id"  style="width:250px;" value="<%=request.getAttribute("newid")%>"  class="form-control">
                                             </div>
                                          </div>
                               <div class="form-group">
                                              <label class="control-label col-sm-4">Category:</label>
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="text" name="category" style="width:250px;" class="form-control" required>
                                              </div>
                                          </div>
                                ...
                                <div class="form-group">
                                              ...
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="text" name="brand" style="width:250px;" class="form-control" required>
                                              </div>
                                          </div>           
                                ...
                                <div class="form-group">
                                              ...
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="text" name="sub_category" style="width:250px;" class="form-control" required>
                                              </div>
                                          </div>
                                          <div class="form-group">
                                              <label class="control-label col-sm-4">Stock
						Available:</label>
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="number" min="1" max="99999999999" name="stock_available" style="width:250px;"  class="form-control" required>
                                              </div>
                                          </div>
                                          <div class="form-group">
                                              <label class="control-label col-sm-4">Cost per Unit:</label>
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="number" min="1" max="99999999999" name="cost" style="width:250px;" class="form-control" required>
                                              </div>
                                          </div>
                                          <div class="form-group">
                                              <label class="control-label col-sm-4">Stock
						Sold :</label>
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="number" min="1" max="99999999999" name="stock_sold" style="width:250px;" class="form-control" required>
                                              </div>
                                          </div>
                                          <div class="form-group">
                                              <label class="control-label col-sm-4">Inventory Holding Cost per unit :</label>
                                              <div class="col-sm-6">
                                                  <input id="cp1" type="number" min="1" max="99999999999" name="holding_cost" style="width:250px;" class="form-control" required>
                                              </div>
                                          </div>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
