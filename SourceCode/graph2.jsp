          ...
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i>Statistics</li>
						<li><i class="fa fa-laptop"></i>Brand-Wise</li>						  	
					</ol>
				</div>
			</div>
   ...
   <div class="panel-body">
		<div class="form">
			...
			<form class="form-validate form-horizontal" id="feedback_form"
				...
				<input type="hidden" name="action" value="brand_graph">
...
<center>
		...
		<img src="uploads/<%=request.getAttribute("brand1")%>.png" alt="" height="500" width="1300">
		<br>
		<br>
		<img src="uploads/<%=request.getAttribute("brand2")%>.png" alt="" height="500" width="1300">
