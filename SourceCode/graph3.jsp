			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-laptop"></i>Product-Wise</li>						  	
					</ol>
				</div>
			</div>
	 ...
	 <div class="panel-body">
		<div class="form">
			...
			<form class="form-validate form-horizontal" id="feedback_form"
				...
				<input type="hidden" name="action" value="product_graph">
...
<h3>Product:&nbsp;&nbsp; 
		...
		<br><br>
				<button class="btn btn-primary btn-lg" 
					...
					<br><br>
<img src="uploads/<%=request.getAttribute("product")%>.jpg" alt="" height="500" width="1300">
