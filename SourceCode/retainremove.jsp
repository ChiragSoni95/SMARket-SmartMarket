          ...
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i>Forecasting</li>
						<li><i class="fa fa-laptop"></i>Remove Products</li>						  	
					</ol>
				</div>
			</div>
	...
	<div class="panel-body">
		<div class="form">
			...
			<form class="form-validate form-horizontal" id="feedback_form"
				...
				<input type="hidden" name="action" value="outlier1">
<center>
				<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
			...
			&nbsp;&nbsp;
					...
					Threshold Percentage: <input name="threshold"
...
<sql:query dataSource="${ds}" var="result">
SELECT * from cold where category='<%=request.getAttribute("category")%>' AND sold_percent< <%=request.getAttribute("threshold")%>;
</sql:query>
				...
				<td>
					<div class="btn-group">
						...
						<a class="btn btn-danger"
							href="<%=request.getContextPath() %>/Controller?action=outlier-delete&id=<c:out value="${row.product_id}"/>"><i
