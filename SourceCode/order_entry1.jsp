...
<!-- container section start -->
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
												<li><i class="fa fa-laptop"></i>Confirmation</li>						  	
					</ol>
				</div>
			</div>
	   ...
	   <h2>
		<center><b><font color="red"><%=request.getAttribute("class")%></font></b></center>
		<br>
		<center><b><font color="red"><%=request.getAttribute("class1")%></font></b></center>
	</h2>
	<br>
	<br>
	<center>
	<h3>Do you want to place an order?</h3>
	<br>


<a class="btn btn-primary btn-lg" href="<%=request.getContextPath()%>/Controller?action=order_confirm">Confirm</a>
	...
	<a class="btn btn-danger btn-lg" data-toggle="modal"
		href="<%=request.getContextPath()%>/Controller?action=order_reject">
		Reject </a>
