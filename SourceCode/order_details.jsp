  ...
  <section id="container" class="">
          ...
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
												<li><i class="fa fa-laptop"></i>Stock Quantity</li>						  	
					</ol>
				</div>
			</div>
	...
	<div class="panel-body">
		...
		<form class="form-horizontal " method="post" action="<%=request.getContextPath()%>/Controller">
               <input type="hidden" name="action" value="order1">
                              ...
                              <div class="form-group">
                                             ...
                                             <div class="col-sm-6">
                                                  <input id="cp1" name="quantity"  style="width:150px;"   type="number" min="1" max="99999999999" class="form-control" required />
                                             </div>
                                             </div>
